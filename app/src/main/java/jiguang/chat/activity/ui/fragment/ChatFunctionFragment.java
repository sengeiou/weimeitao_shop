...
public class ChatFunctionFragment extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        if (rootView == null) {
            ...
            rootView.findViewById(R.id.chat_function_photo).setOnClickListener(new View.OnClickListener() {
                @Override
            ...
            rootView.findViewById(R.id.chat_function_photograph).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    if (ContextCompat.checkSelfPermission(getActivity(),
                            Manifest.permission.WRITE_EXTERNAL_STORAGE)
